...
class AmazonEbayItem
{
    ...
    public function addPropertiesToItem(array $data, $amazonItem)
    {
        ...
        $this->item->Quantity = (int) $amazonItem->getStockForEbay();
        ...
        $this->item->StartPrice = new Types\AmountType(['value' => (double) $amazonItem->getPriceForEbay()]);


        //$this->item->Title = $data['title'];
        $this->item->Title = $amazonItem->getTitleForEbay();
        
        //$this->item->Description = $data['description'];
        $this->item->Description = $amazonItem->getDescriptionForEbay();
