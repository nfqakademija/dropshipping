 ...
 */
final class Version20190528202517 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ebay_item ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE ebay_item ADD CONSTRAINT FK_E7C3CEC3A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_E7C3CEC3A76ED395 ON ebay_item (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ebay_item DROP FOREIGN KEY FK_E7C3CEC3A76ED395');
        $this->addSql('DROP INDEX IDX_E7C3CEC3A76ED395 ON ebay_item');
        $this->addSql('ALTER TABLE ebay_item DROP user_id');
        $this->addSql('ALTER TABLE image CHANGE ali_express_product_id_id ali_express_product_id_id INT DEFAULT NULL');
